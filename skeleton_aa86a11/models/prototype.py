...
from skeleton_aa86a11.data.batch import HIDBatch
from skeleton_aa86a11.evaluation.evaluator import (
    EmbeddingSample,
    EvaluationPair,
    SpeakerRecognitionEvaluator,
)
from skeleton_aa86a11.layers.arcface import ArcMarginProduct
from skeleton_aa86a11.layers.cosface import HotelIdModel
...
class HotelID(LightningModule):
    ...
    def forward(self, images: t.Tensor) -> t.Tensor:
        ...
        # NOTE: This is a change from aa86a11 for evaluation purposes!
